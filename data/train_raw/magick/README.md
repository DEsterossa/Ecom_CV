...
- Of course, you can also git clone this hugginface repository via `git clone https://huggingface.co/datasets/OneOverZero/MAGICK` to download the whole thing in one go. Its approximately 200GB.

![CVPR2024 Poster](https://ryanndagreat.github.io/MAGICK/poster.png)
